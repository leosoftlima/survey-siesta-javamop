...
# Carregar o CSV
csv_path = r"C:\Users\leona\Downloads\expermentSurvey\RQ2\respostas_RQ2_Faster.csv"
...
# Plot MSL
plt.figure(figsize=(12, 6))
sns.heatmap(heatmap_data_msl, annot=True, cmap='YlOrBr', cbar_kws={'label': '% MSL'}, linewidths=0.5, fmt='.1f', mask=mask_javamop)
